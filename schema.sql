...
-- Run this script to understand the database structure
-- To create database: Run db.py (which uses db_config.py)
-- =====================================================
...
-- =====================================================
-- TABLE: users
-- Description: Stores user information (customers, staff, admins)
-- =====================================================
...
VALUES (1, 'Admin', 'User', 'admin@inventory.com', 
